...
class Advice extends CI_Controller
{
    ...
    public function index()
    {
      ...
      else
      {
        ...
        if ($q <> '') {
            $config['base_url'] = base_url() . 'advice/index?q=' . urlencode($q);
            $config['first_url'] = base_url() . 'advice/index?q=' . urlencode($q);
        } else {
            $config['base_url'] = base_url() . 'advice/index';
            $config['first_url'] = base_url() . 'advice/index';
        }
	...
	xlsWriteLabel($tablehead, $kolomhead++, "Advice");
	...
	foreach ($this->Advice_model->get_all() as $data) {
	    ...
	    xlsWriteLabel($tablebody, $kolombody++, $data->advice);
